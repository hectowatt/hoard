...
// クライアントがスマホサイズのときの入力フォームコンポーネント
export default function InputFormSmallScreen({ open, onClose, onInsert, onInsertTableNote }: InputFormProps) {
        ...
        <>
            <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth fullScreen>
                <DialogTitle sx={{ pt: 12 }}>
                    <TextField
                        inputProps={{ placeholder: t("placeholder_input_title") }}
                        fullWidth
                        variant="standard"
                        value={title}
                ...
                <DialogContent sx={{ mt: 7 }}>
                    <TextField
                        ...
                        variant="standard"
                        sx={{ mb: 2 }} />
                    <Button onClick={saveButtonClick} variant="contained" sx={{ fontSize: isSmallScreen ? '0.7rem' : '0.875rem', mr: 1 }} data-testid="button_save">{t("button_save")}</Button>
                    <Button onClick={closeInputTableNote} variant="contained" sx={{ fontSize: isSmallScreen ? '0.7rem' : '0.875rem', mr: 1 }} data-testid="button_cancel">{t("button_cancel")}</Button>
            ...
            <Dialog open={tableNoteOpen} onClose={closeInputTableNote} maxWidth="sm" fullWidth fullScreen>
                <DialogTitle sx={{ pt: 8 }}>
                    <TextField
                        label={t("label_title")}
                        variant="standard"
                        value={title}
                        onChange={(e) => setTitle(e.target.value)}
                        data-testid="input_title_table_note"
                        fullWidth
                        margin="normal" />
                </DialogTitle>
                <DialogContent>
                    ...
                    <Box sx={{ p: 2 }}>
                        ...
                        <Button onClick={closeInputTableNote} variant="contained" sx={{ mb: 1, fontSize: isSmallScreen ? '0.7rem' : '0.875rem' }}>
                            {t("button_cancel")}
                        </Button>
